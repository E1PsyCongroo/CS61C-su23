...
int abs_matrix(matrix *result, matrix *mat) {
    ...
    //     vals = _mm256_andnot_pd(sign_mask, vals);
...
int mul_matrix(matrix *result, matrix *mat1, matrix *mat2) {
    ...
    /* SIMD */
    // double *tmp_data = malloc((sizeof *tmp_data) * result->rows * result->cols);
    // double *transport_mat2 = malloc((sizeof *transport_mat2) * mat2->rows * mat2->cols); // transport_mat2[mat2->cols][mat2->rows] = mat2[mat2->rows][mat2->cols]^T
